...
<html>
    ...
    <body style="padding-right: 50px" class="bodysign_Up" id="fontsALL">
        <h2 class="headers">Update Information</h2>
        <div id="log_in_forms">
        ...
        <div class="sign_Up">
            ...
            <form  action="sign_up.php" method="post">
                ...
                <h4>Last Name</h4>
                    ...
                    <br><br>
                <button type="submit" value='submit' name='register' class="button">Save</button>
